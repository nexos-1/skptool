...
- On Linux, all tests also run in CI with Blender 5.2.0, plus a check with real files in Docker (`tools/linux_e2e.sh`); on macOS without Blender. The window tests of the live mode only run on Windows.
