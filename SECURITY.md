...
- Unter Linux laufen alle Tests in der CI auch mit Blender 5.2.0, dazu eine Prüfung mit echten Dateien in Docker (`tools/linux_e2e.sh`), unter macOS ohne Blender. Die Fenster-Tests des Live-Modus laufen nur unter Windows.
